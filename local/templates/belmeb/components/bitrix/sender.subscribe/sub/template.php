...
?>
	...
	<form role="form"  class="subscribe-block-form" method="post" action="<?=$arResult["FORM_ACTION"]?>"  onsubmit="BX('bx_subscribe_btn_<?=$buttonId?>').disabled=true;">
		<?=bitrix_sessid_post()?>
		<input type="hidden" name="sender_subscription" value="add">
        <input class="bx-form-control" type="text" name="SENDER_SUBSCRIBE_EMAIL" placeholder="Введите ваш e-mail">
        <input type="submit"  id="bx_subscribe_btn_<?=$buttonId?>">
	</form>
<?
$frame->beginStub();
?>
